    ...
    <form id="form_product" method="post" enctype="multipart/form-data" action="<?=site_url($action_form)?>">
        <div class="form-row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="nome" name="nome" placeholder="Nombre" required value="<?= (isset($produto) ? $produto->nome : '') ?>">
            </div>
            <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="preco" name="preco" placeholder="Precio" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" aria-describedby="inputGroupPrepend" required value="<?= (isset($produto) ? $produto->preco : '') ?>">
                </div>
            </div>
        </div>
        <div class="form-row">
            <div class="col-md-12 mb-3">
                ...
                <textarea class="form-control" id="descricao" name="descricao" placeholder="Descripcion"><?= (isset($produto) ? htmlspecialchars($produto->descricao) : '') ?></textarea>
            </div>
        </div>
