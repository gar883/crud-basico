...
<div class="container container-person mt-5 p-5">
    ...
    <form id="form_make_order" method="post" action="<?=site_url($action_form)?>">
        <?php foreach ($products as $product) { ?>
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 col-xs-4"><b>Nombre</b></div>
                    <div class="col-sm-3 col-xs-3"><b>Precio</b></div>
                    <div class="col-sm-2 col-xs-2"><b>Cantidad</b></div>
                </div>
                <div class="row">
                    <div class="col-sm-4 col-xs-4"><?= $product->nome ?></div>
                    <div class="col-sm-3 col-xs-3">$ <?= $product->preco ?></div>
